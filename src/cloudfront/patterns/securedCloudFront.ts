...
`;
    ...
    if (this.enableRefreshEndpoint) {
      ...
      const refreshVersion = refreshFunction.currentVersion.node.defaultChild as core.CfnResource;
      if (refreshVersion) {
        refreshVersion.applyRemovalPolicy(core.RemovalPolicy.RETAIN);
      }
...
`;
      ...
      const logoutVersion = logoutFunction.currentVersion.node.defaultChild as core.CfnResource;
      if (logoutVersion) {
        logoutVersion.applyRemovalPolicy(core.RemovalPolicy.RETAIN);
      }
    ...
    this.distribution = new cloudfront.Distribution(this, 'Distribution', {
      ...
      defaultBehavior: (() => {
        ...
        return {
          ...
          functionAssociations: this.mergeFunctionAssociations(defaultBuilt?.functionAssociations, props.defaultBehavior.functionAssociations),
  ...
  public addBehavior(
    ...
    this.distribution.addBehavior(pathPattern, origin, {
      ...
      functionAssociations: this.mergeFunctionAssociations(built?.functionAssociations, addBehaviorOptions.behaviorOptions?.functionAssociations),
